...
const Sellerform = () => {
  ...
  const [joiningStatus, setJoiningStatus] = useState("join"); // Default to "join"
  const [groupMembers, setGroupMembers] = useState("");

  // New fields for state, district, industry, and category
  ...
  const submithandler = (e) => {
    ...
    axios
      .post(`${url}watsappregister`, groupData)
      .then((res) => {
  ...
  return (
    <div className="sellerform-container">
      ...
      <form className="sellerform-form" onSubmit={submithandler}>
        <h2>Register Group Information</h2> <br />
        <label className="sellerform-label">Group Name</label>
        <input
        ...
        />
        <label className="sellerform-label">Group Link</label>
        <input
          className="sellerform-input"
          type="text"
          value={groupLink}
        ...
        />
        <label className="sellerform-label">Group Description</label>
        <textarea
          className="sellerform-input"
        ...
        <label className="sellerform-label">Joining Status</label>
        <select
          className="sellerform-input"
          value={joiningStatus}
        ...
        <label className="sellerform-label">Group Members</label>
        <input
          className="sellerform-input"
          type="number"
          value={groupMembers}
