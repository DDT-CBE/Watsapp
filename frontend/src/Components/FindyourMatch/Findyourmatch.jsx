  ...
  return (
    <Fragment>
     ...
     <h1 className='title'>For Registration & Search</h1>
            ...
            <Link to={"/watsapp"} style={{textDecoration:"none"}}> <div className='findbtn' >Watsapp Connect</div></Link>   
            <Link to={"/influencer"} style={{textDecoration:"none"}}> <div className='findbtn' >Influencer Connect</div></Link>  
